...
export const GET = async (
  ...
  try {
    ...
    const typesWithKoreanNames: Pokemon[] = await Promise.all(
    ...
    const abilitiesWithKoreanNames: Pokemon[] = await Promise.all(
    ...
    const movesWithKoreanNames: Pokemon[] = await Promise.all(
